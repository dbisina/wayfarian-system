...
interface NewJourneyScreenProps {
  onBack: () => void;
  onStartTracking: () => void;
}

const NewJourneyScreen = ({onBack, onStartTracking}: NewJourneyScreenProps): React.ReactElement => {
        ...
        >
          <View style={styles.dateTimeContainer}>
            <TextInput
              ...
              placeholderTextColor="#999999"
            />
            <Icon name="event" size={24} color="#999999" style={styles.calendarIcon} />
          </View>
        </TouchableOpacity>
