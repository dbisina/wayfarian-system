...
const MapScreen = ({onStartJourney}: MapScreenProps): React.ReactElement => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.mapContainer}>
        <MapView
          ...
          style={styles.map}
          initialRegion={sanFranciscoRegion}
          ...
          {getFilteredLocations().map(location => (
            <Marker
              ...
              description={`Category: ${location.category}`}>
        ...
        <TouchableOpacity style={styles.navigationButton}>
          <Icon name="navigation" size={24} color="#000000" />
        </TouchableOpacity>
